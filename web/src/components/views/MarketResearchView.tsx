  ...
  return (
    <div className="animate-slide-up space-y-5">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        {indices.map((idx) => (
          <div key={idx.thscode} className="rounded-2xl border border-white/[0.07] bg-[#141a22] p-4">
    ...
    <section className="rounded-2xl border border-white/[0.07] bg-[#141a22] p-4">
      ...
      <ul className="space-y-2">
        {rows.map((r) => (
          <li
            key={r.code + r.right}
            className="flex items-center justify-between gap-3 border-b border-white/[0.07] py-2 last:border-0"
          >
