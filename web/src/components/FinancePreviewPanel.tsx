...
export default function FinancePreviewPanel() {
  ...
  return (
    <div className="flex h-full flex-col bg-[#10141a]">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/[0.07] bg-[#141a22] px-4 py-2.5">
...
function EmptyState() {
  return (
    <div className="flex h-full flex-col items-center justify-center bg-[#10141a] px-8 text-center">
      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#4f8cff]/12 text-2xl">
        同
      </div>
