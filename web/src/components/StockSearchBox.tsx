...
export default function StockSearchBox({
  ...
  return (
    <div ref={wrapRef} className={`relative ${className}`}>
      <div className="flex items-center gap-2 rounded-lg border border-white/10 bg-[#1c2430] px-3 py-2 focus-within:border-[#4f8cff]/40">
        {loading ? (
      ...
      {open && (results.length > 0 || error) && (
        <div className="absolute left-0 right-0 z-50 mt-1 max-h-72 overflow-auto rounded-xl border border-white/10 bg-[#1c2430] shadow-2xl">
          {error ? (
